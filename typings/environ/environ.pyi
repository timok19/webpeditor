...
class Env:
    ...
    def str(self, var, default=..., multiline=...):
        """
        :rtype: str
        """
        ...
    ...
    db = ...
    def cache_url(self, var=..., default=..., backend=...):
    ...
    cache = ...
    def email_url(self, var=..., default=..., backend=...):
    ...
    email = ...
    def search_url(self, var=..., default=..., engine=...):
    ...
    @classmethod
    def cache_url_config(cls, url, backend=...):
    ...
    @classmethod
    def email_url_config(cls, url, backend=...):
    ...
    @classmethod
    def search_url_config(cls, url, engine=...):
    ...
    @classmethod
    def read_env(cls, env_file=..., overwrite=..., encoding=..., **overrides):
