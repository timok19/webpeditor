...
class EditorOriginalImageAsset(BaseImageAsset):
    ...
    class Meta(BaseImageAsset.Meta):
        verbose_name: str = _("Original Image Asset")
        verbose_name_plural: str = _("Original Image Assets")
...
class EditorEditedImageAsset(BaseImageAsset):
    ...
    class Meta(BaseImageAsset.Meta):
        verbose_name: str = _("Edited Image Asset")
        verbose_name_plural: str = _("Edited Image Assets")
...
class EditorEditedImageAssetFile(BaseImageAssetFile):
    ...
    class Meta(BaseImageAssetFile.Meta):
        verbose_name: str = _("Edited Image Asset File")
        verbose_name_plural: str = _("Edited Image Asset Files")
