...
class OriginalImage(models.Model):
    ...
    original_image_url = models.ImageField(upload_to="", max_length=6_000_000, default=None)
...
class EditedImage(models.Model):
    ...
    edited_image_url = models.ImageField(upload_to="", max_length=6_000_000, default=None)
    session_id = models.CharField(max_length=1023, null=True)
    created_at = models.DateTimeField(default=timezone.now)
    updated_at = models.DateTimeField(default=timezone.now)
