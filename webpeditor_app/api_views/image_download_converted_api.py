...
from cloudinary.utils import download_zip_url  # pyright: ignore [reportMissingTypeStubs]
...
def __get_user_id_and_converted_images(request: WSGIRequest) -> JsonResponse | tuple[str, list[Any]]:
    ...
    converted_images: list[Any] | None = request.session.get("converted_images")
