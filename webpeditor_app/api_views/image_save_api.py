...
from webpeditor_app.api_views.utils.api_response_presets import UnauthorizedAccessResponseRedirect, ResultJsonResponse, Result
from webpeditor_app.models import EditedImageAsset
...
def image_save_api(request: WSGIRequest) -> UnauthorizedAccessResponseRedirect | JsonResponse | ResultJsonResponse | HttpResponse | None:
    if request.method == "POST":
        ...
        EditedImageAsset.objects.filter(user_id=user_id).update(image_url=cloudinary_image.url)
